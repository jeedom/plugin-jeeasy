...
<div class="row row-overflow">
	...
	<div class="col-lg-10" id="div_jeeasyConfigureObject">
		...
		<div class="jeeasyDisplay home">
			...
			<br />
			<center>
				<div class="alert alert-info">{{Bienvenu sur l'assistant de configuration de votre maison, nous allons configurer ensemble votre pièce :}} <strong><?php echo $object->getName(); ?></strong></div>
			</center>
		...
		<div class="jeeasyDisplay main" style="display:none;">
			...
			<br />
			<center>
				<div class="alert alert-info">{{Nous allons ici configurer votre pièce à travers quelques petite questions}}</div>
			</center>
		...
		<div class="jeeasyDisplay display" style="display:none;">
			...
			<br />
			<center>
				<div class="alert alert-info">{{Nous allons ici configurer l'affichage de votre pièce}}</div>
			</center>
			<form class="form-horizontal">
				<fieldset>
					<div class="form-group">
