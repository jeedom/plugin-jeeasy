...
<div class="row row-overflow">
	...
	<div class="col-lg-10" id="div_jeeasyDisplay">
		...
		<div class="jeeasyDisplay display" style="display:none;">
			...
			<center>
				<div class="alert alert-info">{{Nous allons ici configurer l'affichage de votre frigo à travers quelque(s) question(s) très simple}}</div>
			</center>
		...
		<div class="jeeasyDisplay alerts" style="display:none;">
			...
			<center>
				<div class="alert alert-info">{{Nous allons ici configurer des alertes sur votre frigo en cas de soucis à travers quelque(s) question(s) très simple}}</div>
			</center>
			<form class="form-horizontal">
				<fieldset>
					<div class="form-group">
		...
		<div class="jeeasyDisplay history" style="display:none;">
			...
			<center>
				<div class="alert alert-info">{{Nous allons ici configurer la gestion de l'historique de la température de votre frigo}}</div>
			</center>
			<form class="form-horizontal">
				<fieldset>
					<div class="form-group">
		...
		<div class="jeeasyDisplay battery" style="display:none;">
			...
			<center>
				<div class="alert alert-info">{{Nous allons ici configurer la gestion de la batterie (si le module est sur batterie sinon vous pouvez passer à l'étape suivante)}}</div>
			</center>
			<form class="form-horizontal">
				<fieldset>
					<div class="form-group">
		...
		<div class="jeeasyDisplay end" style="display:none;">
			...
			<br />
			<center>
				<div class="alert alert-success">{{Bravo !!! Vous avez fini de configurer votre frigo :  }}<strong><?php echo $eqLogic->getHumanName() ?></strong></div>
			</center>
