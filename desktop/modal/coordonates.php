...
<div class="modalContainer" style="display:flex;flex-direction:column;align-items:center;height:100%; width:100%;">
  ...
  <div class="input-group" id="gpsCoordonates" style="width:50%;min-width:600px;">
    ...
    <span id="validCoordonates" class="input-group-addon roundedRight modern-btn-disabled">{{Valider les coordonnées}}
  ...
  <span style="font-size:12px;margin-top:1%;">{{Alimenté par}} OpenStreetMap <a>(https://www.openstreetmap.org/)</a></span>
</div>
  ...
  (function() {
    ...
    function initializeMap(latitude, longitude) {
      ...
      marker = new L.marker([latitude, longitude], {
        ...
        autoPan: true,
        icon: customIcon
      }).addTo(map).bindPopup('Vous pouvez affiner la position en déplaçant le marqueur', {
        className: 'popUp'
      }).openPopup();
      ...
      bootbox.confirm({
        ...
        callback: function(result) {
          if (result) {
            ...
            $('#div_alert').showAlert({
              message: "Adresse enregistrée en configuration",
              level: 'success'
            });
          }
          bootbox.confirm({
