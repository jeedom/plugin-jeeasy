...
?>
  ...
  <script>
    ...
    function dnsInstall() {
       ...
       document.querySelector('.textAtlas').innerHTML = '{{La mise en place de l\'acces distant est en cours... Veuillez patientez}}';
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          document.querySelector('.textAtlas').innerHTML = '{{La mise en place de l\'acces distant s\'est effectuée avec succès}}';
