...
<div class="row row-overflow">
	...
	<div class="col-lg-10" id="div_jeeasyIncludeDisplay">
		...
		<div class="jeeasyDisplay include" style="display:none;">
			...
			<br/>
			<center><div class="alert alert-info">{{C'est partie, lançons nous. Pour commencer ajoutez votre nouveau module à l'application Sonos.}}</div></center>
			...
			<br/>
			<center><a class="btn btn-default" id="bt_jeeasySyncSonos3"><i class="fa fa-refresh"></i> {{Synchroniser}}</a></center>
		</div>
