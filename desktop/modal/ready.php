...
?>
	<h3>{{Félicitations}} !</h3>
	<img src="plugins/jeeasy/core/img/greenthumb.png" alt="{{pouce de validation}}" style="width:180px;">
	<div>{{Vous pouvez commencer à naviguer dans}} <?php echo config::byKey('product_name') ?>
	...
	?>
		...
		<div>{{Retrouvez la documentation complète}} : <a href="https://www.jeedom.com/doc" target="_blank" class="btn btn-default btn-xs" role="button"><i class="fas fa-book"></i> {{Documentation}}</a></div>
		<div>{{Rejoignez la communauté}} : <a href="https://community.jeedom.com" target="_blank" class="btn btn-default btn-xs" role="button"><i class="fas fa-users"></i> {{Forum}}</a></div>
	<?php
	}
	?>
<?php
