...
<div class="jeeasyDisplay market">
    ...
    <center>
        <div style="text-align: center; font-weight: bold; text-transform: uppercase; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.5);">
            {{Nous allons configurer la connexion de votre}} <?php echo config::byKey('product_name'); ?> {{au market}}
        </div>
...
<!--    <center><i class="far fa-credit-card" style="font-size: 10em;; padding-top: 20px;"></i></center>-->
<!--    <br/>-->
<!--    <center><div style="text-align: center; font-weight: bold; text-transform: uppercase; margin-bottom: 20px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.5);" class="alert">{{Nous allons ici configurer la connexion de votre }} --><?php //echo config::byKey('product_name'); 
                                                                                                                                                                                                                                                        ?>
<!-- {{au market}}</div></center>-->
<!--    <form class="form-horizontal">-->
<!--        <fieldset>-->
<!--            --><?php
                    //            foreach ($repos as $key => $value) {
