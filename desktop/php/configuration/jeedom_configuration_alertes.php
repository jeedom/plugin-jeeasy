...
<div class="jeeasyDisplay alerts">
    ...
    <br />
    <div style="text-align: center; font-weight: bold; text-transform: uppercase; margin-bottom: 10px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.5);">{{Nous allons voir comment votre}} <?php echo config::byKey('product_name'); ?>
        {{peut vous contacter}}
    </div>
