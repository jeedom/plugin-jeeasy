...
?>
    ...
    <div class="jeeasyDisplay main">
        ...
        <br/>
        <div style="text-align: center; font-weight: bold; text-transform: uppercase; margin-bottom: 20px; font-size: 20px; text-shadow: 1px 1px 1px rgba(0,0,0,0.5);">{{Nous allons ici configurer les principaux paramètres de votre}} <?php echo config::byKey('product_name'); ?></div>
...
<php
        include_file('3rdparty', 'deepmerge', 'js', 'jeeasy');
?>
