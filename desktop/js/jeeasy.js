...
$('#bt_jeeasyObjectConfiguration').on('click', function () {
	bootbox.confirm({
		...
		buttons: {
			confirm: {
				label: '<i class="fas fa-plus"></i> {{Créer une nouvelle piece}}',
